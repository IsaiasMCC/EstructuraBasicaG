...
{
    class Soporte : negocio.Object
    {
        public double width;
        public double height;
        public double depth;
        public Soporte(double width, double height, double depth, double centerX, double centerY, double centerZ) : base(centerX, centerY, centerZ)
        {
            this.width = width;
            this.height = height;
            this.depth = depth;
